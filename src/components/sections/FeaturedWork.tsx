...
const projects = [
  ...
  {
    slug: "chaitanya-eng",
    title: "Chaitanya Engineering School",
    subtitle: "CES, Maharashtra",
    category: "Web Platform",
    result: "Engineering college gets a modern web presence — courses, admissions, and campus life all in one place.",
    year: "2025",
    tags: ["Next.js", "TypeScript", "Tailwind", "Vercel"],
    accent: "#0891B2",
    initial: "CE",
